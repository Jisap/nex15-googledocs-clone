...
const FontSizeButton = () => {
  ...
  const currentFontSize = editor?.getAttributes("textStyle").fontSize       // Obtener el tamaño de fuente actual del editor.
  ...
  const updateFontSize = (newSize: string) => {                             // updateFontSize: Actualiza el tamaño de fuente del editor.
    const size = parseInt(newSize)                                          // parseInt: Convierte una cadena en un número entero.
    if(!isNaN(size) && size > 0 ){                                          // Si el tamaño de fuente es un número entero positivo, se ejecuta el siguiente código.
      editor?.chain().focus().setFontSize(`${size}px`).run()                // setFontSize: Establece el tamaño de fuente en el editor.
      setFontSize(newSize)
